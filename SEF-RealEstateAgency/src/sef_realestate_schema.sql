...
(
    `userid`           int(11) NOT NULL,
    `preferredsuburbs` varchar(45) DEFAULT NULL,
...
--
-- Table structure for table `parttimes`
--

DROP TABLE IF EXISTS `parttimes`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `parttimes`
--

LOCK TABLES `parttimes` WRITE;
/*!40000 ALTER TABLE `parttimes`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `parttimes`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `type`       varchar(45) NOT NULL,
    `userid`     int(11)     NOT NULL COMMENT 'listed by',
...
-- Dump completed on 2019-10-12  4:05:26
