...
/*!40000 ALTER TABLE `bankaccounts`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `bankaccounts`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (15, 55000, '2019-10-14', 'admin', NULL),
       (16, 55000, '2019-10-14', 'manager', NULL),
       (17, 55000, '2019-10-14', 'propertymanager', 1),
       (18, 55000, '2019-10-14', 'salesconsultant', 1);
/*!40000 ALTER TABLE `employees`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `preferredsuburbs`
    DISABLE KEYS */;
INSERT INTO `preferredsuburbs`
VALUES (5, 'Melbourne'),
       (7, 'Melbourne'),
       (7, 'South Yarra'),
       (8, 'Melbourne'),
...
VALUES (1, 5000, '2019-10-13 16:39:31', 1, '123 B St', 'Melbourne', 2, 2, 1, 'House', 11, 18, 0, '', 1, NULL, NULL),
       ...
       (5, 12, '2019-10-13 17:10:24', 1, '23 B Rd', 'Richmond', 0, 0, 0, 'House', 12, 17, 1, 'TWO_YEARS', 1,
        '2019-10-14', '2019-10-19'),
       (6, 2122, '2019-10-17 08:01:19', 0, '123 ABC Sales', 'Melbourne', 0, 0, 0, 'Flat', 21, 0, 0, '', 0, NULL, NULL);
/*!40000 ALTER TABLE `properties`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `propertyowners`
    DISABLE KEYS */;
...
VALUES (1, 11112, '2019-10-16 16:11:52', 0, 1, '', 0, 0, 0, 1, NULL);
/*!40000 ALTER TABLE `proposals`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (5, 'renter2', 'a@a.co',
       ...
       (9, 'renter', 'a@a.com',
        ...
        '2019-10-15 11:58:25'),
       (10, 'aaa', 'a@a.com',
        '3741bcb880de3d1d4ad870349c46ff1e80b10a8f7001bd3a7d5745258107bfe4f343923a867a4bdbe6d064e44dc1986ebed98152be983940d231f146c653785a',
        NULL),
       (11, 'vendor', 'vendor@a.com',
        '80f6660c159f392d8a882fab6e8898934c23eb8374ba22db7fe7ac9c82867a330559fb81dae539668e9ad1fedb93d73333b94f54a3e0b9daa8dbe1ff97a28e43',
        '2019-10-13 19:01:33'),
       (12, 'landlord', 'landlord@a.com',
        '80f6660c159f392d8a882fab6e8898934c23eb8374ba22db7fe7ac9c82867a330559fb81dae539668e9ad1fedb93d73333b94f54a3e0b9daa8dbe1ff97a28e43',
        '2019-10-15 10:10:32'),
       (15, 'admin', 'a@a.com',
        '80f6660c159f392d8a882fab6e8898934c23eb8374ba22db7fe7ac9c82867a330559fb81dae539668e9ad1fedb93d73333b94f54a3e0b9daa8dbe1ff97a28e43',
...
/*!40000 ALTER TABLE `workingentries`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `workingentries`
    ENABLE KEYS */;
UNLOCK TABLES;
