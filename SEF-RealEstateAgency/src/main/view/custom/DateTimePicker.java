        ...
        valueProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue == null) {
                ...
                if (dateTimeValue.get() == null) {
                    dateTimeValue.set(LocalDateTime.of(newValue, LocalTime.now().truncatedTo(ChronoUnit.HOURS)));
                } else {
                    LocalTime time = dateTimeValue.get().toLocalTime().truncatedTo(ChronoUnit.HOURS);
